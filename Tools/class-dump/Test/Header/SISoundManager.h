...
@class NSMutableArray, SISound;

@interface SISoundManager : NSObject
{
...
@property(retain, nonatomic) SISound *currentMusic; // @synthesize currentMusic=_currentMusic;
