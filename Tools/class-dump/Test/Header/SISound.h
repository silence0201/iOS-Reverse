...
@interface SISound : NSObject <AVAudioPlayerDelegate>
{
    float _baseVolume;
    float _startVolume;
    float _targetVolume;
...
@property(retain, nonatomic) SISound *selfReference; // @synthesize selfReference=_selfReference;
